...
const Index = () => {
  ...
  const [currentQuestions, setCurrentQuestions] = useState(sampleExamQuestions.slice(0, 10));
    ...
    <div className="min-h-screen bg-exam-bg">
      ...
      <div className="bg-primary text-primary-foreground py-6">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-2">Sri Lanka Driving License Exam</h1>
          <p className="text-xl opacity-90">Voice-Based Testing System for All</p>
        </div>
      </div>
          ...
          <Card className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground">
                Take your driving license exam using voice commands. Perfect for candidates who prefer audio-based interaction.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Listen to questions read aloud in your preferred language</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Simply say A, B, C, or D to answer each question</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Skip questions and return to them later during the exam</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Designed for candidates with varying literacy levels</p>
                </div>
              </div>
            </div>
